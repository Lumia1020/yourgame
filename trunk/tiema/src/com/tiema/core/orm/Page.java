...
public class Page implements Serializable {
	...
	/**
	 * @Title: setPageNo
	 * @Description: 设置当前页的页号,序号从0开始,低于0时自动调整为0.
	 * @param pageNo
	 */
	...
	public void setCriteria(DetachedCriteria dcList) {
		this.criteria = dcList;
	}
