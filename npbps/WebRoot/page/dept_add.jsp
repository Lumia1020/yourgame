...
<html>
	<head>
		...
		<!--[if IE]>
			<link rel="stylesheet" type="text/css" href="<%=basePath%>css/public_ie.css">
		<![endif]-->
		
		<!--[if !IE]><!-->
			<link rel="stylesheet" type="text/css" href="<%=basePath%>css/public_ff.css">
		<!--<![endif]--> 
		<style type="text/css">
	...
	<body>
		<div class="left" style="width: 93%;margin: 20px 30px 10px 30px;">
			<form id="addDeptForm" name="addDeptForm" method="get">
				<table width="600px" id="yd_form" border="0" cellpadding="4" cellspacing="0">
					<tr>
						<td>部门名称</td>
						<td><input type="text" id="deptName" maxlength="20"/><em>*</em></td>
					</tr>
					<tr>
						<td colspan="4" style="padding:8px 0px 10px 10px" align="center">
							<input id="dept_add" type="button" value="添  加" style="width:70px"/>
