 ...
 * 
 * $Id: HibernateDao.java 532 2009-10-13 14:50:54Z calvinxiu $
 */
...
import com.tiema.core.orm.PropertyFilter;
import com.tiema.core.orm.PropertyFilter.MatchType;
import com.tiema.core.utils.ReflectionUtils;
...
public class HibernateDao<T, PK extends Serializable> extends SimpleHibernateDao<T, PK> {
         ...
         * 分页获取全部对象.
         */
        public Page getAll(final Page page) {
         ...
         */
        @SuppressWarnings("unchecked")
        public Page findPage(final Page page, final Criterion... criterions) {
                Assert.notNull(page, "page不能为空");
         ...
         * 按属性过滤条件列表分页查找对象.
         */
        public Page findPage(final Page page, final List<PropertyFilter> filters) {
                Criterion[] criterions = buildPropertyFilterCriterions(filters);
